...
class ProxyHttpClientRequest extends HttpClientRequest {
  final FlutterDomHttpOverrides _httpOverrides;
  ...
  ProxyHttpClientRequest(String method, Uri uri, FlutterDomHttpOverrides httpOverrides, HttpClient nativeHttpClient)
  ...
  Future<HttpClientResponse> close() async {
    int? contextId = FlutterDomHttpOverrides.getContextHeader(headers);
